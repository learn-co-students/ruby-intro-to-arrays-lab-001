...
def first_element(taylor_swift)
    ...
    my_first_array = taylor_swift[0]
end

def third_element(taylor_swift)
    taylor_swift = ["Welcome to New York", "Blank Space", "Style", "Out of The Woods"]

    my_first_array = taylor_swift[2]
...
def last_element(taylor_swift)
    ...
    my_first_array = taylor_swift[-1]
end

def first_element_with_array_methods(south_east_asia)
  south_east_asia = ["Thailand", "Cambodia", "Singapore", "Myanmar"]

  my_first_array = south_east_asia.shift
...
def last_element_with_array_methods(south_east_asia)
  ...
  my_first_array = south_east_asia.pop
